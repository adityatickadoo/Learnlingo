...
const LanguageGrid: React.FC<LanguageGridProps> = ({ onLanguageSelect }) => {
  ...
  const handleLanguageSelect = (language: Language) => {
    console.log('LanguageGrid: Language selected:', {
      id: language.id,
      name: language.name,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-8 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
          <p className="text-white/80 text-sm">
            Debug: Total languages available: {languages.length} | Grouped languages: {Object.keys(groupedLanguages).length}
          </p>
        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="text-left">
                              ...
                              <div className="text-white/40 text-xs">ID: {variant.id}</div>
                            </div>
                          </div>
