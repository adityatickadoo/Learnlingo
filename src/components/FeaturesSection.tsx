...
import { Mic, BarChart3, Globe, BookOpen, MessageSquare, Award, Zap, Users, Brain, Play, ArrowRight } from 'lucide-react';
...
const FeaturesSection: React.FC = () => {
  ...
  const features = [
    {
      ...
      details: ['Adaptive learning algorithms', 'Personalized lesson plans', 'Smart difficulty adjustment']
    },
    {
      icon: MessageSquare,
      ...
      details: ['Natural dialogue flow', 'Real-world scenarios', 'Context-aware responses']
    },
    {
      icon: Mic,
      ...
      details: ['Real-time feedback', 'Accent training', 'Speech pattern analysis']
    },
    {
      icon: BarChart3,
      ...
      details: ['Detailed analytics', 'Learning insights', 'Progress milestones']
    },
    {
      icon: Globe,
      ...
      details: ['Cultural context', 'Local expressions', 'Social etiquette']
    },
    {
      icon: Zap,
      ...
      details: ['Proven methodology', '3x faster results', 'Optimized learning paths']
    },
    {
      icon: BookOpen,
      ...
      details: ['Expert-designed paths', 'Progressive difficulty', 'Comprehensive coverage']
    },
    {
      icon: Award,
      ...
      details: ['Achievement badges', 'Learning streaks', 'Progress celebrations']
    },
    {
      icon: Users,
      ...
      details: ['Diverse personalities', 'Matched preferences', 'Personalized teaching styles']
    }
  ];
  ...
  const handleTryFeature = (featureName: string) => {
    console.log(`Try feature: ${featureName}`);
    // Could trigger feature demo or navigation
  };
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className={`relative backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:scale-105 hover:bg-white/15 h-full ${isActive ? 'ring-2 ring-emerald-400/50 bg-white/20' : ''}`}>
                  {/* Icon */}
                  ...
                  {isActive && (
                    <div className="space-y-2 mb-4 animate-pulse">
                      {feature.details.map((detail, detailIndex) => (
                        <div key={detailIndex} className="flex items-center text-emerald-300 text-sm">
                  ...
                  <button
                    ...
                    className={`w-full mt-4 py-3 px-4 bg-gradient-to-r ${feature.color} text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center group/btn`}
                  >
        ...
        <div className="text-center mt-20">
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-xl max-w-2xl mx-auto">
            ...
            <button 
              onClick={() => console.log('Experience All Features clicked')}
